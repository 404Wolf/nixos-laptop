...
in
  ...
  ''
  + ''
    bind=$MOD SHIFT ALT, M, fullscreenstate, 0, 2
  ...
  ''
    ...
    bind=$MOD SHIFT, T, exec, app2unit -- ${pkgs.kitty}/bin/kitty --title kitty_centersmall
    bind=$MOD, C, exec, [float] app2unit -- ${pkgs.qalculate-qt}/bin/qalculate-qt
